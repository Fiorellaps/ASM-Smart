...
export const TestListLiteComponent: React.FC<Props> = (props) => {
            ...
            Cell: ({ cell, row }) => (
              <Box display="flex" flexDirection="row">
                <Tooltip title="Visualizar">
                  <ListItemIcon>
                    <MenuItem
                      to={routes.testView(row.original.idTest)}
                      component={Link}
                    >
                      <RemoveRedEye />
                    </MenuItem>
    ...
    <>
      <MaterialReactTable
        ...
        initialState={{
          ...
          sorting: [
            { id: 'porcentajeCorrecto', desc: false },
            { id: 'fechaUltimaEjecucion', desc: true },
          ],
        }}
